    ...
    <div className="bg-card border border-border rounded-xl p-6">
          ...
          >
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-foreground">{region?.members?.toLocaleString()}</span>
              </div>
              ...
              {selectedRegion === region?.id && (
                <div className="pt-2 border-t border-border space-y-2 animate-in slide-in-from-top-2">
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="text-foreground">{Math.floor(region?.members * 0.15)?.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-muted-foreground">Tournaments</span>
                    <span className="text-foreground">{Math.floor(region?.members / 100)}</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-muted-foreground">Avg. Level</span>
                    <span className="text-foreground">{Math.floor(Math.random() * 50) + 25}</span>
                  </div>
                </div>
              )}
            </div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="text-center p-4 bg-muted rounded-lg">
          ...
          <div className="text-lg font-semibold text-foreground">47,832</div>
        ...
        <div className="text-center p-4 bg-muted rounded-lg">
          ...
          <div className="text-lg font-semibold text-foreground">156K</div>
